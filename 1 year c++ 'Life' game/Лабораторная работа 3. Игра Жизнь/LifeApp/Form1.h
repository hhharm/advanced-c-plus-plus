...
namespace LifeApp {
	...
	public:
		...
		virtual void SetExpressionError(Servant::state state)override;
	protected:
		/// <summary>
	...
	private: System::Windows::Forms::Label^  Polsk;
	private: System::Windows::Forms::TextBox^  Expression;
	private: System::Windows::Forms::Label^  label2;


	private: System::Windows::Forms::Label^  ExpressionStateLabel;
	...
	private: System::Windows::Forms::Label^  PolskExpressionLabel;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Polsk = (gcnew System::Windows::Forms::Label());
			this->Expression = (gcnew System::Windows::Forms::TextBox());
			this->label2 = (gcnew System::Windows::Forms::Label());
			this->ExpressionStateLabel = (gcnew System::Windows::Forms::Label());
			...
			this->PolskExpressionLabel = (gcnew System::Windows::Forms::Label());
			...
			this->flowLayoutPanel1->Location = System::Drawing::Point(526, 56);
			...
			this->flowLayoutPanel2->Size = System::Drawing::Size(480, 532);
			...
			this->button1->Location = System::Drawing::Point(587, 224);
			...
			this->button2->Location = System::Drawing::Point(526, 224);
			...
			this->button3->Location = System::Drawing::Point(642, 224);
			...
			this->button4->Location = System::Drawing::Point(543, 278);
			...
			this->button5->Location = System::Drawing::Point(543, 306);
			...
			this->button6->Location = System::Drawing::Point(543, 419);
			...
			this->button7->Location = System::Drawing::Point(543, 490);
			...
			this->label1->Location = System::Drawing::Point(584, 25);
			...
			// Polsk
			// 
			this->Polsk->Anchor = System::Windows::Forms::AnchorStyles::Right;
			this->Polsk->AutoSize = true;
			this->Polsk->Location = System::Drawing::Point(769, 165);
			this->Polsk->Name = L"Polsk";
			this->Polsk->Size = System::Drawing::Size(214, 17);
			this->Polsk->TabIndex = 7;
			this->Polsk->Text = L"Выражение в польской записи:";
			// 
			// Expression
			// 
			this->Expression->Anchor = System::Windows::Forms::AnchorStyles::Right;
			this->Expression->Location = System::Drawing::Point(772, 87);
			this->Expression->Name = L"Expression";
			this->Expression->Size = System::Drawing::Size(266, 22);
			this->Expression->TabIndex = 8;
			this->Expression->Text = L"a1*3 + a3*2+a4*2+a5*6+a8*7";
			this->Expression->TextChanged += gcnew System::EventHandler(this, &Form1::Expression_TextChanged);
			this->Expression->Enter += gcnew System::EventHandler(this, &Form1::Expression_Enter);
			this->Expression->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &Form1::Expression_KeyPress);
			this->Expression->Leave += gcnew System::EventHandler(this, &Form1::Expression_Leave);
			this->Expression->MouseCaptureChanged += gcnew System::EventHandler(this, &Form1::Expression_MouseCaptureChanged);
			// 
			// label2
			// 
			this->label2->Anchor = System::Windows::Forms::AnchorStyles::Right;
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(769, 54);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(126, 17);
			this->label2->TabIndex = 9;
			this->label2->Text = L"Ваше выражение:";
			// 
			// ExpressionStateLabel
			// 
			this->ExpressionStateLabel->Anchor = System::Windows::Forms::AnchorStyles::Right;
			this->ExpressionStateLabel->Location = System::Drawing::Point(789, 112);
			this->ExpressionStateLabel->Name = L"ExpressionStateLabel";
			this->ExpressionStateLabel->Size = System::Drawing::Size(223, 53);
			this->ExpressionStateLabel->TabIndex = 11;
			this->ExpressionStateLabel->Text = L"(корректно)";
			// 
			// dataGridView1
			// 
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(2) {this->VarName, 
				this->VarValue});
			this->dataGridView1->EditMode = System::Windows::Forms::DataGridViewEditMode::EditOnKeystroke;
			this->dataGridView1->GridColor = System::Drawing::SystemColors::ActiveCaption;
			this->dataGridView1->Location = System::Drawing::Point(772, 224);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->ScrollBars = System::Windows::Forms::ScrollBars::Vertical;
			this->dataGridView1->Size = System::Drawing::Size(255, 363);
			...
			// VarName
			// 
			this->VarName->HeaderText = L"Имя переменной";
			this->VarName->Name = L"VarName";
			this->VarName->ReadOnly = true;
			// 
			// VarValue
			// 
			this->VarValue->HeaderText = L"Значение";
			this->VarValue->Name = L"VarValue";
			// 
			// PolskExpressionLabel
			// 
			this->PolskExpressionLabel->AllowDrop = true;
			this->PolskExpressionLabel->Anchor = System::Windows::Forms::AnchorStyles::Right;
			this->PolskExpressionLabel->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->PolskExpressionLabel->FlatStyle = System::Windows::Forms::FlatStyle::Popup;
			this->PolskExpressionLabel->Location = System::Drawing::Point(723, 195);
			this->PolskExpressionLabel->Name = L"PolskExpressionLabel";
			this->PolskExpressionLabel->Size = System::Drawing::Size(329, 23);
			this->PolskExpressionLabel->TabIndex = 13;
			this->PolskExpressionLabel->Text = L"label3";
			this->PolskExpressionLabel->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &Form1::PolskExpressionLabel_Paint_1);
			// 
			// Form1
			// 
			...
			this->ClientSize = System::Drawing::Size(1064, 592);
			this->Controls->Add(this->PolskExpressionLabel);
			this->Controls->Add(this->dataGridView1);
			this->Controls->Add(this->ExpressionStateLabel);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->Expression);
			this->Controls->Add(this->Polsk);
...
private: System::Void Form1_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		string os;
		const char* chars = 
			(const char*)(Runtime::InteropServices::Marshal::
				StringToHGlobalAnsi(Expression->Text)).ToPointer();
		os = chars;			
		Runtime::InteropServices::Marshal::FreeHGlobal(IntPtr((void*)chars));
		GetModel()->SetExpression(os);
		GetModel()->ConvertCommand();
		ChangeTable();
		 }
...
private: System::Void Expression_TextChanged(System::Object^  sender, System::EventArgs^  e) {
		try
				 {
					 timer1->Stop();
				//переводим System::String в std::string
				string os;
				const char* chars = 
					(const char*)(Runtime::InteropServices::Marshal::
						StringToHGlobalAnsi(Expression->Text)).ToPointer();
				...
				ChangeTable();
				 ...
				 {
					 MessageBox::Show("Не вводите русские буквы!");
				 }
		}
private: System::Void Expression_Leave(System::Object^  sender, System::EventArgs^  e) {
		
		 }
private: System::Void Expression_MouseCaptureChanged(System::Object^  sender, System::EventArgs^  e) {
...
private: System::Void Expression_Enter(System::Object^  sender, System::EventArgs^  e) {
...
private: System::Void dataGridView1_CellEndEdit(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e) {
			 ...
			 for (i = 0, it = GetModel()->GetVarList()->begin(); i < e->RowIndex + num_cells_in_temp; it++) i++;
			 try
			 {
			 value = Convert::ToInt32(dataGridView1[1,e->RowIndex]->Value);
			 }
			 catch (...) 
			 {
				 MessageBox::Show("Вы ввели неверное значение. Сбрасываю его.");				 
				 value = 0;
...
private: System::Void PolskExpressionLabel_Paint_1(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
		//преобразование из std::string в System::String
			PolskExpressionLabel->Text =  gcnew System::String((GetModel()->GetPolskExpression()).c_str());
