...
void Form1::Paint2D(Graphics ^g, int width,	 int height,  IField *field,int row, int colm)
	{
			 Color PenColor;
...
void BufferForm::showline(Graphics^ g, int width,  int height,  IField *field,int row, int colm, int set_h)
	{
